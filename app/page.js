    ...
    return (
      <div style={{ textAlign: "center", padding: "6rem 0" }}>
        ...
        <div style={{ display: "flex", gap: "1rem", justifyContent: "center", flexWrap: "wrap", marginBottom: "4rem" }}>
          <Link href="/explore" className="btn btn-outline landing-btn" style={{ padding: "0.75rem 1.5rem", fontSize: "1.1rem" }}>
            <Compass size={18} />
            Explore Public Board
          </Link>
          <button onClick={() => signIn("google")} className="btn btn-primary landing-btn" style={{ padding: "0.75rem 1.5rem", fontSize: "1.1rem" }}>
            <LogIn size={18} />
            Sign in with Google
          </button>
        </div>
